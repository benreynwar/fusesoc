...
def generate(generator, name, parameters, cache_root, files_root, core_name):
    ...
    Args:
        ...
        cache_root (str): The directory where to store he generated cores
...
"""
    ...
    Launcher(os.path.join(os.path.abspath(generator.root), generator.command),
