...
if __name__ == '__main__':
    ...
    top_name = 'dummy_top'
    work_root = 'deleteme'
    cm.add_cores_root('/home/ben/Code/dummy_generator')
    core_requirements = get_core_requirements(top_name, work_root)
    print(core_requirements)
    all_top_generics = [
        {'width1': 1, 'width2': 2, 'width3': 3},
        {'width1': 3, 'width2': 2, 'width3': 1},
    ]
    src_files, incdirs = run_generators(core_requirements, work_root, top_name,
                                        all_top_generics)
    print([s.name for s in src_files], incdirs)
